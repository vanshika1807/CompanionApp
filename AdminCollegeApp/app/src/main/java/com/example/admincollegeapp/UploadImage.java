...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Important Tasks", "Independence Day", "Republic day","Sports Days","Hackathons","Convocation","Exam Schedule","Unifest","Freshers","Festival Celebration","Other Events"};
